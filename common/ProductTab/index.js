...
class ProductTab extends React.Component {
    ...
    getDefaultActiveKey = () => {
        ...
        if (matchUrl === locationUrl) {
            ...
            // 例如：/product-manage/product-detail 指向产品基本信息。/product-manage/product-detail/product-liability指向产品级别約定下的寿险产品基本属性。
            this.setState({
                defaultActiveKey: '1'
            });
        } else {
    ...
    changeTab = (value) => {
        ...
        const matchUrl = this.props.match.url;
        // 如果是【产品理赔责任】下【责任与责任約定】下的三级路由（基本約定/医疗费用約定），保留url上的libilityId.其他都去掉。
